...
def execute(expr_param, file_idx):
    ...
    alpha_inf, alpha_rem = {'lower': (1.5, 2.5), 'higher': (2.5, 1.5), 'equal': (2, 2)}[expr_param]
    ...
    # if expr_param == 'higher' and file_idx < 6: return {'res': {'res': [0]}} #beta_coef = func.find_weibull_coef_from_g(0.14, 1 + (6 + 1) * 0.1 / 3, alpha_inf, alpha_rem, unit_beta_inf, unit_beta_rem, 160000, 1 / basic_params.day_div)
...
# if __name__ == '__main__':
#     total_res = [execute('equal', i) for i in [3]]
