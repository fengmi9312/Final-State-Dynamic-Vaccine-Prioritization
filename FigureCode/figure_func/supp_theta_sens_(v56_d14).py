...
def draw(anal_data):
    fig, axes = prototype_prdt_from_dysttg_for_sens.draw(anal_data, param = 'v56_d14', r0_limit = 55, vac_dur = 30)
    ...
    for idx in range(3):
        ...
        ax.text(0.02, 0.98, r'$\theta = 0.56\%, \delta = 14$', fontsize = 15, transform = ax.transAxes, ha = 'left', va = 'top')
