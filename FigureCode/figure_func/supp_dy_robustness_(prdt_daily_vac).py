# -*- coding: utf-8 -*-
"""
Created on Sun Jul  6 20:26:46 2025
...
def draw(anal_data):
    fig, axes = prototype_prdt_from_param.draw(anal_data, param = 'daily_vac')
    ...
    for idx in range(3):
        ...
        plt.xticks(np.arange(1, 6) / 1000, np.arange(1, 6) / 10)
        figure_setting.set_xylabel(ax, r'Daily Vaccine Supply $\theta$ (%)',  ylabels[idx], fontsize = 16, xlabel_coords = -0.1, ylabel_coords = -0.075 if idx != 2 else -0.09)
