...
from .figure_dependencies import prototype_prdt_from_dysttg_for_nm, figure_setting
from matplotlib.patches import FancyBboxPatch
from matplotlib.transforms import Bbox

def draw(anal_data):
    fig, axes = prototype_prdt_from_dysttg_for_nm.draw(anal_data, param = 'lower', r0_limit = 55, vac_dur = 60)
    ...
    for idx in range(3):
        ...
        if idx == 0: ax.legend(ncol=1, loc='upper left', bbox_to_anchor=(0.54, 0.5), frameon=False)
            # lines  = ax.get_lines()
