# -*- coding: utf-8 -*-
"""
Created on Sun Jul  6 20:08:04 2025
...
def draw(anal_data):
    fig, axes = prototype_prdt_from_param.draw(anal_data, param = 'vac_dur')
    ...
    for idx in range(3):
        ...
        plt.xticks(np.arange(0, 121, 40), np.arange(0, 121, 40))
        figure_setting.set_xylabel(ax, r'Vaccination Campaign Duration $T_{\mathrm{vac}}$',  ylabels[idx], fontsize = 16, xlabel_coords = -0.1, ylabel_coords = -0.075 if idx != 2 else -0.09)
