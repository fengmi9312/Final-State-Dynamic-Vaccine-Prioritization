...
anal_list = ['prdt_from_dysttg', 'prdt_from_dysttg_for_sens', 'ipeak_from_dysttg']
...
fig_dict = {'framework': ['state_aggregation_alpha']}
fig_dict = {'supp_delta_sens': ['v35_d7', 'v35_d21'], 'supp_theta_sens': ['v14_d14', 'v56_d14']}
fig_dict = {'supp_nf_robustness_nm': ['total_fig'], 'supp_delta_sens': ['v35_d7', 'v35_d21'], 'supp_theta_sens': ['v14_d14', 'v56_d14'], 'supp_ipeak_robustness': ['time', 'r0']}
fig_dict = {'supp_allocs_with_reg': ['prdts',]}
